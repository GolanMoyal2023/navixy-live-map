...
# Installs NavixyApi, NavixyTunnel, and NavixyDashboard as Windows services
...
Write-Host "Installing Navixy Services" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
& $nssm set NavixyApi Description "Navixy Live Map API Server (Flask)"
...
& $nssm set NavixyTunnel Description "Cloudflare Quick Tunnel for Navixy Live Map"
...
Write-Host "  - NavixyApi (Port 8765)" -ForegroundColor White
Write-Host "  - NavixyTunnel (Cloudflare)" -ForegroundColor White
Write-Host "  - NavixyDashboard (Port 8766)" -ForegroundColor White
Write-Host ""
